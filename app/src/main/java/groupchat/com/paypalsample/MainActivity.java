package groupchat.com.paypalsample;
...
public class MainActivity extends Activity implements OnClickListener,
    ...
    public void PayPalButtonClick(View arg0) {
        ...
        // number.
        payment.setRecipient("kapilsharmaphysics@gmail.com");
        ...
        // PAYMENT_TYPE_NONE.
        payment.setPaymentType(PayPal.ENV_SANDBOX);
        ...
        if (_method == METHOD_DELIVERY) {
            invoice.setShipping(new BigDecimal(2));
        ...
        if (_cheese) {
            ...
            // Sets the total price which should be (quantity * unit price). The total prices of all PayPalInvoiceItem should add up
            // to less than or equal the subtotal of the payment.
            item2.setTotalPrice(new BigDecimal(2));
            // Sets the unit price.
            item2.setUnitPrice(new BigDecimal(2));
            // Sets the quantity.
            item2.setQuantity(1);
            // Add the PayPalInvoiceItem to the PayPalInvoiceData. Alternatively, you can create an ArrayList<PayPalInvoiceItem>
            // and pass it to the PayPalInvoiceData function setInvoiceItems().
